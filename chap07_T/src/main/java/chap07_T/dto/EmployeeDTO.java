...
public class EmployeeDTO {
	...
	//가져오고 싶은 것들 DB에서 가져오는 것들은 컬럼명을 맞춰주는게 좋다
	...
	private Integer department_id; // join 시킬 수도 있음으로
	...
	public String getDivRow() {
		return String.format("<div>%d</div>"
				...
				+"<div>%s</div>"
				+"<div>%d</div>"
				+"<div>%d</div>", employee_id, first_name, last_name, salary,
				commission_pct, hire_date, job_id, manager_id, department_id);
	}
